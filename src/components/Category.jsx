...
import BathroomDesign from "../assets/images/image3.jpg";
...
export default function CollectionShowcase() {
  return (
    <section className="py-4 md:py-12 bg-[#212121]">
      <div className="max-w-8xl mx-auto px-5 lg:px-12">
        

        {/* Images */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 cursor-pointer">
          {collections.map((item, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <h3 className="text-white text-2xl md:text-4xl font-regular tracking-wide text-center">
                  {item.name}
                </h3>
              </div>
            </div>
